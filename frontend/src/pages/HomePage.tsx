...
>
  BusManager
          ...
          <button
            ...
            className="hidden md:flex items-center space-x-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-xl transition-all duration-300 border border-white/20"
          >
            <span>Connexion</span>
