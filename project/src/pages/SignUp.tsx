        ...
        <form className="space-y-5 rounded-2xl border border-white/10 bg-white/5 p-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-white/10 bg-black/25 px-4 py-2.5 text-white focus:border-gray-400 focus:outline-none"
          ...
          {form.department === 'driver' && (
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-gray-400/40 bg-gray-500/10 px-4 py-2.5 text-white focus:border-gray-400 focus:outline-none"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-gray-700 px-4 py-3 text-center text-base font-semibold text-white shadow-lg shadow-gray-500/30 transition hover:bg-gray-600 disabled:cursor-not-allowed disabled:opacity-60 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
