        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 space-y-10 text-center">
            <h1 className="text-5xl font-bold leading-tight md:text-7xl">
              ...
              <span
                className="block text-5xl text-transparent bg-gradient-to-r from-gray-500 via-gray-600 to-white bg-clip-text shiny-text"
                style={{
                  textShadow:
                    '0 0 20px rgba(160, 160, 160, 0.5), 0 0 40px rgba(200, 200, 200, 0.3)',
                }}
              >
                Optimisée et Connectée
              </span>
            ...
            <div className="flex flex-col items-center justify-center gap-4 pt-4 sm:flex-row">
              <button
                onClick={() => navigate("/sign-up")}
                className="flex items-center px-8 py-4 space-x-2 text-lg font-semibold transition-all duration-300 border bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-xl border-white/20"
              >
                <span>Créer un compte</span>
              </button>
