      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="space-y-5 rounded-2xl border border-white/10 bg-white/5 p-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-black/30 px-3 py-2 focus-within:border-gray-400">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-gray-700 px-4 py-3 text-center text-base font-semibold text-white shadow-lg shadow-gray-500/30 transition hover:bg-gray-600 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <p className="text-center text-sm text-slate-400">
          Besoin d’un accès ?{' '}
          <Link to="/sign-up" className="text-gray-300 hover:text-gray-200">
            Créer un compte
          </Link>
        </p>
        <button
